...
URLKernel='https://raw.githubusercontent.com/bakuniverse/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/bakuniverse/serverSpeeder_kernel/master/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "http://176.122.190.67/lot.php?mac=$MAC&year=2034-12-31"
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://raw.githubusercontent.com/bakuniverse/serverSpeeder_Install/master/appex.zip"
